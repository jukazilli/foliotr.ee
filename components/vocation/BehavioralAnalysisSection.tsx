      ...
      <div className="grid gap-5 lg:grid-cols-[minmax(0,1fr)_minmax(18rem,0.8fr)]">
        <div className="min-w-0">
          ...
          <div className="mt-5 flex flex-wrap gap-2">
            <span className="rounded-full border-2 border-line bg-lime px-3 py-1 text-sm font-semibold">
              RIASEC {result.riasecCode}
            </span>
            <span className="rounded-full border-2 border-line bg-pink px-3 py-1 text-sm font-semibold">
          ...
          {topAreas.map((item) => (
            <article key={item.area.id} className="border-2 border-line bg-white p-4">
              <div className="flex items-center justify-between gap-3">
                <h3 className="text-base font-semibold">{item.area.area}</h3>
                <span className="font-semibold text-blue">{item.score}</span>
              </div>
      ...
      <div className="mt-6 grid gap-5 lg:grid-cols-2">
        <BehavioralRadar
          ...
          legend={[
            {
              label: "Abertura",
              description: "O quanto você busca novas ideias e experiências.",
            },
            {
              label: "Conscienciosidade",
              description: "O quanto você é organizado e focado em metas.",
            },
            {
              label: "Extroversão",
              description: "O quanto você ganha energia interagindo com outros.",
            },
            {
              label: "Amabilidade",
              description: "O quanto você prioriza a harmonia e o bem-estar do grupo.",
            },
            {
              label: "Estabilidade Emocional",
              description: "O quanto você lida bem com o estresse e a pressão.",
            },
          ]}
        />
        <BehavioralRadar
